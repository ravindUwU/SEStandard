namespace RavinduL.SEStandard.Http
{
	...
	/// <summary>
	/// Provides a mechanism to perform HTTP requests using an instance of the <see cref="HttpClient"/> class.
	/// </summary>
	...
	public sealed class HttpClientRequester : IHttpRequester
	{
		...
		/// <exception cref="ArgumentNullException">Thrown when the specified <see cref="HttpClient"/> is <c>null</c>.</exception>
		...
		/// <exception cref="ArgumentException">Thrown when the specified <see cref="HttpRequestMethod"/> is invalid.</exception>
